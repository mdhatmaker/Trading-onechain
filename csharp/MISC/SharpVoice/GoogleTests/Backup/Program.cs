...
namespace GoogleTests
{
    static class Program
    {
        ...
        static void Main()
        {
			...
			*/
            try {
				string email = "scott.mundorff@gmail.com";
				Console.Write("Login for "+email+"; password: ");
                //Time to make the voice connection object!
                Voice voice = new Voice(email,Console.In.ReadLine());
				voice.login();

				voice.call("7175216367", "5705036367");
