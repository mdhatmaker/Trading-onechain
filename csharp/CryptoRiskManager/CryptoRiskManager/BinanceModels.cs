...
namespace WebSocketTest
{
    ...
    public struct BinanceTicker
    {
        ...
        public BinanceTicker(decimal bid, decimal bidSize, decimal ask, decimal askSize, long time)
        {
            Bid = bid;
            BidSize = bidSize;
            Ask = ask;
        ...
        public BinanceTicker(JObject jo)
        {
    ...
    public class BinanceOrder : BinanceObject
    {
        public string symbol { get; set; }
    ...
    public class BinanceOrderList : List<BinanceOrder>, BinanceObject
    {        
        public bool IsNull { get { return false; } }    // TODO: implement IsNull property
    }

    public class BinanceStartUserDataStream : BinanceObject
    {
    ...
    public class BinanceOutboundAccountInfo : BinanceObject
    {
    ...
    public class BinanceExecutionReport : BinanceObject
    {
        public string e { get; set; }       // Event type
        public long E { get; set; }         // Event time
    ...
    public class BinanceAccountInfo : BinanceObject
    {
    ...
    public class BinanceOrderBookTicker : BinanceObject
    {
        public string symbol { get; set; }
    ...
    public class BinanceOrderBookTickerList : List<BinanceOrderBookTicker>, BinanceObject
    {
