...
{
    public partial class DPModifyFoo
#if DESIGNER
        : DPModifyControlStub
#else
        : DPModifyControl
#endif
    {
        ...
        public override string ControlName { get { return "ModifyFoo"; } }
        ...
        public DPModifyFoo(KeyValueCollection propertyValues) : base(propertyValues)
        {
            InitializeComponent();
