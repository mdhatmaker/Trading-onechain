...
{
    public partial class DPModifyMarketData
#if DESIGNER
        : DPModifyControlStub
#else
        : DPModifyControl
#endif
    {
        ...
        public override string ControlName { get { return "ModifyMarketData"; } }
        ...
        public DPModifyMarketData(KeyValueCollection propertyValues) : base(propertyValues)
        {
            InitializeComponent();
