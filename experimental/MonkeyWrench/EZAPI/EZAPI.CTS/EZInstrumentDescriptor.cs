...
namespace EZAPI.Framework
{
    ...
    /// </summary>
    public class EZInstrumentDescriptor
    {
        /// <summary>
        /// Product key for the instrument we will subscribe to
        /// </summary>
        public ezProductKey ProductKey { get; set; }
        /// <summary>
        ...
        private EZInstrumentDescriptor()
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            EZInstrumentDescriptor compareObject = obj as EZInstrumentDescriptor;
