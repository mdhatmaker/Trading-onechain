...
namespace EZAPI.Framework.Chart.Indicators
{
    public class WeightedClose : Indicator
    {
        ...
        public WeightedClose(string name = "Weighted Close", string description = "", string moreInfoWebPage = "")
            : base(name)
        {
            ...
            if (description == "")
                this.description = "The weighted close formula calculates the average value of daily prices, but gives more weight to the close price.";
            if (moreInfoWebPage == "")
        ...
        {
            string INDICATOR = "WeightedClose";
            ...
            chart1.DataManipulator.FinancialFormula(MSChart.FinancialFormula.WeightedClose, "candlestickSeries:Y1,candlestickSeries:Y2,candlestickSeries:Y3", INDICATOR + ":Y");
