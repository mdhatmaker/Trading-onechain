...
namespace EZAPI.Framework.Chart.Indicators
{
    public class NegativeVolumeIndex : Indicator
    {
        ...
        public NegativeVolumeIndex(string name = "Negative Volume Index", string description = "", string moreInfoWebPage = "")
            : base(name)
        {
            ...
            if (description == "")
                description = "The negative volume index formula helps identify a bull market. When the negative volume index is above its moving average there is higher probability for a bull market. The probability for a bull market is much lower when the negative volume index is below its moving average. This formula should be used together with the Positive Volume Index Formula.";
            if (moreInfoWebPage == "")
                moreInfoWebPage = "http://stockcharts.com/school/doku.php?id=chart_school:technical_indicators:negative_volume_inde";

            // ADD PARAMETERS HERE
            AddParameter(new IndicatorParameter<int>("StartNVI", "Start value of the negative volume index.", 100));
        ...
        {
            int startNVI = (int)parameters["StartNVI"].Value;
            ...
            string INDICATOR = "NegativeVolumeIndex";
            ...
            string formulaParameters = string.Format("{0}", startNVI);
            ...
            chart1.DataManipulator.FinancialFormula(MSChart.FinancialFormula.NegativeVolumeIndex, formulaParameters, "candlestickSeries:Y3,candlestickVolumeSeries:Y", INDICATOR + ":Y");
