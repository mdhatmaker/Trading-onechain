...
namespace EZAPI.Framework.Chart.Indicators
{
    public class StandardDeviation : Indicator
    {
        ...
        public StandardDeviation(string name = "Standard Deviation", string description = "", string moreInfoWebPage = "")
            : base(name)
        {
            ...
            if (description == "")
                this.description = "The standard deviation formula is used to indicate volatility. It calculates the difference between values like the close price and their moving average. A higher standard deviation indicates higher volatility.";
            if (moreInfoWebPage == "")
                this.moreInfoWebPage = "http://stockcharts.com/school/doku.php?id=chart_school:technical_indicators:standard_deviation_v";

            // ADD PARAMETERS HERE
            AddParameter(new IndicatorParameter<int>("Period", "Period for calculating the moving average for the standard deviation.", 15));
        ...
        public override void Draw(MSChart.Chart chart1, bool enable = true)
        {
            ...
            string INDICATOR = "StandardDeviation";
            ...
            chart1.DataManipulator.FinancialFormula(MSChart.FinancialFormula.StandardDeviation, formulaParameters, "candlestickSeries:Y3", INDICATOR + ":Y");
