...
namespace EZAPI.Framework.Chart.Indicators
{
    public class MedianPrice : Indicator
    {
        ...
        public MedianPrice(string name = "Median Price", string description = "", string moreInfoWebPage = "")
            : base(name)
        {
            ...
            if (description == "")
                this.description = "The median price formula calculates the average value of daily high and low prices.";
            if (moreInfoWebPage == "")
